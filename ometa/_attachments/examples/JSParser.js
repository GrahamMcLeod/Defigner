...
JSParser.hexDigits = "0123456789abcdef"
JSParser.keywords  = { }
...
JSParser._isKeyword = function(k) { return this.keywords.hasOwnProperty(k) }


ometa SemActionParser <: JSParser {
...
// an example
tree = JSParser.matchAll("for (var i = 0; i < 0x25; i++) alert('i = ' + i)", "topLevel")
code = JSTranslator.match(tree, "trans")
